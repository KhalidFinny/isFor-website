    ...
    <nav class="w-64 h-screen bg-white border-r border-gray-200 fixed left-0 top-0">
        <div class="flex flex-col h-full">
            ...
            <div class="p-6 border-b border-gray-200">
                <a href="/IsFor-Website/App/views/main/home.php" class="flex items-center space-x-3">
                    <img src="/IsFor-Website/App/public/assets/images/Logo1.png" alt="Logo" class="h-8">
            ...
            <div class="flex-1 overflow-y-auto py-6">
                <div class="px-4 space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="/isFor-website/App/views/user/userdashboard.php" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-900 hover:bg-blue-50">
                        ...
                        <a href="/isFor-website/App/views/main/home.php" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-900 hover:bg-blue-50">
                            <svg class="w-5 h-5 mr-3 text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            Beranda
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="/isFor-website/App/views/user/submit-letter.php" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-900 hover:bg-blue-50">
                            <svg class="w-5 h-5 mr-3 text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-4 border-t border-gray-200">
                <form action="/IsFor-Website/App/controllers/authcontroller.php" method="POST">
