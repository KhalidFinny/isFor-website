...
<body>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <a href="/isfor-web/App/views/main/home.php" class="flex-shrink-0 flex items-center space-x-3">
                        <img src="/isfor-web/App/public/assets/images/Logo1.png" alt="IsFor Logo" class="h-10 w-auto" />
                    ...
                    <div class="hidden lg:flex lg:items-center">
                        ...
                        <div class="ml-8">
                            <a href="/isfor-web/App/views/auth/loginpage.php"
    ...
    <script src="/isfor-web/App/public/assets/js/navbar.js"></script>
  </body>
</html>
