...
<head>
    ...
    <link rel="stylesheet" href="/isfor-web/App/public/assets/css/login.css">
...
<div class="w-full max-w-md fade-enter-active">
        <div class="card-container rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                <img src="/isfor-web/App/public/assets/images/Logo1.png" alt="IsFor Logo" class="h-16 mx-auto mb-4 hover:scale-110 transition-transform duration-300"/>
            ...
            <!-- Login Form -->
            <form id="loginForm" class="space-y-4" method="POST" action="/isfor-web/App/controllers/AuthController.php">
                <!-- Username Input -->
                <div>
    ...
    <script src="/isfor-web/App/public/assets/js/login.js"></script>
</body>
</html>