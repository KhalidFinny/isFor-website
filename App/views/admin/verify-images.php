            ...
            <main class="py-10 px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="col-span-full text-center py-16 bg-white rounded-2xl border-2 border-blue-100">
                        <img src="/isfor-web/App/public/assets/images/empty-images.png" alt="No Images" class="mx-auto h-40 animate-bounce">
                    ...
                    <div class="image-card bg-white rounded-2xl border-2 border-blue-100 overflow-hidden">
                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['title']; ?>" class="w-full h-48 object-cover">
                        <div class="p-6">
