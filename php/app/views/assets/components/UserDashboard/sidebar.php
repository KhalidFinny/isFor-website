            ...
            <div class="flex-1 overflow-y-auto py-6">
                <div class="px-4 space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="<?= BASEURL; ?>/galleries/uploadImgView" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="<?= BASEURL; ?>/galleries/imgHistoryView" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            Riwayat Gambar
