...
<div class="flex flex-col lg:flex-row min-h-screen bg-white">
    ...
    <div class="flex-1 lg:ml-64 page-content">
        <main class="p-4 lg:p-8 max-w-[1600px] mx-auto">
            <div class="max-w-7xl mx-auto mb-6 lg:mb-12">
            ...
            <!-- Header -->
            <div class="max-w-7xl mx-auto mb-6 lg:mb-12 fade-in">
                <div class="flex items-center space-x-4 mb-4">
                    <span class="h-px w-12 bg-red-600"></span>
                    <span class="text-red-600 font-medium">Files</span>
                </div>
                <h1 class="text-3xl lg:text-5xl font-bold text-red-900 mb-2">Verifikasi File</h1>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8">
                <?php if (empty($data['files'])): ?>
                    <div class="col-span-1 sm:col-span-2">
                        <div class="flex flex-col items-center justify-center h-[300px] lg:h-[400px]">
                            <div class="w-16 h-16 lg:w-20 lg:h-20 border-2 border-red-200 rounded-full flex items-center justify-center mb-6 relative">
                                <div class="absolute inset-0 border-2 border-green-200 rounded-full animate-ping opacity-100"></div>
                                <svg class="w-8 h-8 lg:w-10 lg:h-10 text-red-500" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                          d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                </svg>
                            </div>
                            <h3 class="text-lg lg:text-xl font-medium text-red-900 mb-2">Tidak Ada File</h3>
                            <p class="text-sm text-red-600">File yang membutuhkan verifikasi akan muncul di sini</p>
                        </div>
                    </div>
                <?php else: ?>
                    <?php foreach ($data['files'] as $file): ?>
                        <div class="file-card group relative bg-white border border-gray-200 rounded-lg p-4 lg:p-6 transition-all duration-300 hover:border-red-200"
                             data-file-id="<?= $file['research_output_id']; ?>">
                            <div class="absolute -top-2.5 right-4 lg:right-6">
                                <span class="status-badge inline-flex items-center px-2 lg:px-3 py-1 rounded-full text-xs font-medium bg-red-50 text-red-700 border border-red-100">
                            ...
                            <div class="mb-6 lg:mb-8">
                                <div class="flex items-center gap-3 lg:gap-4 mb-4">
                                    <?php
