...
<body class="bg-white">
    ...
    <script>
        function edit(formSelector, successCallback, errorCallback) {
            ...
            // Hapus loop debug yang tidak diperlukan
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                dataType: 'json', // Respons otomatis diparsing menjadi objek
            ...
            $('#editUserForm').on('submit', function(event) {
                ...
                edit('#editUserForm',
                    function onSuccess(response) {
                        ...
                        $('#profilePic').attr('src', '../app/img/profile/' + response.profile_picture);
