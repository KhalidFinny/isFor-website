                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" id="name" required
                                class="form-input w-full px-4 py-2.5 rounded-xl text-gray-600 placeholder-gray-400
                                          border-2 border-red-100 focus:border-red-500 focus:ring-0 transition-all duration-200" placeholder="Masukkan nama lengkap">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" name="email" id="email" required
                                class="form-input w-full px-4 py-2.5 rounded-xl text-gray-600 placeholder-gray-400
                                          border-2 border-red-100 focus:border-red-500 focus:ring-0 transition-all duration-200" placeholder="Masukkan email">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="username" id="username" required
                                class="form-input w-full px-4 py-2.5 rounded-xl text-gray-600 placeholder-gray-400
                                          border-2 border-red-100 focus:border-red-500 focus:ring-0 transition-all duration-200" placeholder="Masukkan username">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="password" name="password" id="password" required
                                class="form-input w-full px-4 py-2.5 rounded-xl text-gray-600 placeholder-gray-400
                                          border-2 border-red-100 focus:border-red-500 focus:ring-0 transition-all duration-200" placeholder="Masukkan password">
                        </div>
