        ...
        function filter(status, currentPage = 1) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Kita asumsikan container surat mencakup keseluruhan letter-card
                    const $letterContainer = $(".letter-card");
                    const $navElement = $('nav[aria-label="Page navigation example"]');

                    // Bersihkan container surat dan navigasi
                    $letterContainer.empty();
                    $navElement.empty();

                    // Jika tidak ada surat, tampilkan pesan "Belum ada surat"
                ...
                `);
                    ...
                    // Jika ada surat, re-render struktur tabel terlebih dahulu
                    $letterContainer.html(`
                <table class="w-full min-w-[800px]">
                    <thead>
                        <tr class="text-left text-sm font-medium text-gray-500">
            ...
            `);
                    ...
                    // Populate table rows dengan data surat
                ...
                `;
                    ...
                    // Generate pagination jika elemen navigasi ada
