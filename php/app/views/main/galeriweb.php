...
<section class="min-h-screen py-20 relative overflow-hidden">
    ...
    <?php foreach ($data['galleries'] as $index => $item): ?>
        <div class="gallery-item group border border-red-600 bg-white rounded-xl hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-red-500" style="animation-delay: <?php echo $index * 0.1; ?>s">
...
<!--    const GALLERY = '<?php //= GALLERY ?>//'; -->
<!-- </script>-->
<!-- <script src="<?php //= JS; ?></gallery_web.js"></script>-->
