...
class GalleryModel
{
    ...
    public function create($image, $category, $title, $uploaded_by)
    {
        $query = "INSERT INTO " . $this->table . " (image, category, title, uploaded_by, created_at)
              VALUES (:image, :category, :title, :uploaded_by, GETDATE())";
